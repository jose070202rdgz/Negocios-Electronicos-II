...
const Cliente = sequelize.define('Cliente', {
  ...
  correo: { type: DataTypes.STRING(150), allowNull: false, unique: true, validate: { isEmail: { msg: 'El correo no es válido' } } },
  ...
  etapa_crm: { type: DataTypes.ENUM('Prospecto', 'Activo', 'Frecuente', 'Inactivo'), allowNull: false, defaultValue: 'Prospecto' },
